/**
 * CardSwap — GSAP-powered perspective card swapping animation.
...
/* ── Card (individual card shell) ─────────────────────────────────────────── */
export const Card = forwardRef(({ customClass, children, style, onClick, ...rest }, ref) => (
    <div
        ref={ref}
        onClick={onClick}
        style={style}
        className={`absolute top-1/2 left-1/2 rounded-2xl border border-white/10 bg-vantage-charcoal
                    shadow-2xl [transform-style:preserve-3d] [will-change:transform]
